    ...
    <main className="mx-auto min-h-[60vh] w-full max-w-md px-4 py-16">
      ...
      <form className="space-y-4">
        <div className="space-y-2">
          ...
          <input className="w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100" placeholder="Your name" />
        </div>
        <div className="space-y-2">
