    ...
    <div className="mx-auto w-full max-w-md">
      ...
      <div className="grid gap-4">
        <div className="grid gap-2">
          ...
          <input id="name" value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Ramesh Kumar" className="rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm outline-none ring-zinc-400 focus:ring-2 dark:border-zinc-800 dark:bg-zinc-950" />
        </div>
        <div className="grid gap-2">
