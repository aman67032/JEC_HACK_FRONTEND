          ...
          <header className="sticky top-0 z-50 border-b border-[color:var(--color-border)] bg-[color:var(--background)]/85 backdrop-blur">
            <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-2">
              ...
              <div className="flex items-center gap-3">
                <a href="/" className="rounded-full px-5 py-2 text-xl font-semibold tracking-wide text-[color:var(--color-foreground)] hover:bg-black/[.04]">Home</a>
                <a href="/dashboard" className="rounded-full px-5 py-2 text-xl font-semibold tracking-wide text-[color:var(--color-foreground)] hover:bg-black/[.04]">Dashboard</a>
                <AuthControls />
                <EmergencyNavButton />
              </div>
            </nav>
          </header>
          <main className="mx-auto min-h-[calc(100dvh-56px)] w-full max-w-6xl px-6 py-10">
            {children}
          </main>
